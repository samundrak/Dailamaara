...
public class PlayerCardCtrl extends InputListener {
    private Card card;
    private np.com.samundrakc.game.controllers.dailamaara.CardDistribution context;
    private float x, y;
    private Game mainGame;

    public PlayerCardCtrl(Card card, np.com.samundrakc.game.controllers.dailamaara.CardDistribution context, Game mainGame) {
        this.card = card;
