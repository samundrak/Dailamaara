...
import np.com.samundrakc.game.controllers.subControllers.Sort;
import np.com.samundrakc.game.controllers.subControllers.Sound;
import np.com.samundrakc.game.controllers.subControllers.Turup;
...
public class CardDistribution {
    ...
    public CardDistribution startShare(int from, final int numberOfCardsToThrow, final int sum) {
        ...
        timer.scheduleTask(new Timer.Task() {
            @Override
            public void run() {
                if (game.getMainGame().getSTATE() == Const.STATE.PAUSE) return;
